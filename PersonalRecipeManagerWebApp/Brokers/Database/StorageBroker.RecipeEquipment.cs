...
namespace PersonalRecipeManagerWebApp.Brokers
{
    public partial class StorageBroker
    {
        ...
        public async ValueTask<RecipeEquipment> SelectRecipeEquipmentByIdAsync(Guid recipeId, Guid ingredientId) =>
            await SelectAsync<RecipeEquipment>(recipeId, ingredientId);
