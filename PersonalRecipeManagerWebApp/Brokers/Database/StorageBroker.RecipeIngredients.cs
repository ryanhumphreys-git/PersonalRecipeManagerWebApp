...
public partial class StorageBroker
{
    ...
    public async ValueTask<RecipeIngredients> SelectRecipeIngredientsByIdAsync(Guid recipeId, Guid ingredientId) =>
        await SelectAsync<RecipeIngredients>(recipeId, ingredientId);
